...
// "event"	function whose parameters correspond to	"struct AFiredWeapon_eventGetPerfectFireStart_Parms"	is declared	in "..\Engine\Classes\Equipment\FiredWeapon.uc"
struct AFiredWeapon_eventGetPerfectFireStart_Parms
{
	  FVector outLocation;
...
// Enum EGSProfileResult is declared in "..\Engine\Classes\GameSpy\GameSpyManager.uc"
...
public:
    ...
    FLOAT OverrideArmDamageModifier;
	  ...
	  {
        AFiredWeapon_eventGetPerfectFireStart_Parms Parms;
...
public:
    ...
    TArrayNoInit<FString> CustomTeamKeyNames;
	  ...
	  void	eventGameSpyInitialised()
	  {
	   ...
	   DECLARE_CLASS(UGameSpyManager,UObject,0,Engine)
...
public:
    ...
    FLOAT MomentumToDamageConversionFactor;
	  ...
	  void	eventPreLevelChange(class UPlayer* thePlayer, const FString& MapName)
	  {
	   ...
	   DECLARE_CLASS(URepo,UObject,0|CLASS_Transient,Engine)
...
public:
    ...
    class UViewport* Viewport;
	  ...
	  void	eventOnCommandRecognized(FName Rule, FName Value, BYTE Confidence)
	  {
